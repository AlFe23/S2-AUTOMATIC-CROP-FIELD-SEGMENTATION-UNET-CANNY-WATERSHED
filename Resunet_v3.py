...
#from tensorflow.keras.metrics import Precision, Recall, BinaryAccuracy #, BinaryIoU
...
from keras.layers import Conv2D, Conv2DTranspose, MaxPooling2D, concatenate, Input, Add, BatchNormalization, Activation
from keras.callbacks import ModelCheckpoint, EarlyStopping, ReduceLROnPlateau, TensorBoard
from keras.metrics import Precision, Recall, BinaryAccuracy, BinaryIoU
...
model_checkpoint_path = os.path.join(weights_run_directory, 'U-Net-Weights-BFCE.keras')
